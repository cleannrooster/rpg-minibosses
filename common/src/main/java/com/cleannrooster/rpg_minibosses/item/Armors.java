...
public class Armors {
    ...
    public static RegistryEntry<ArmorMaterial> material(String name,
        ...
        var material = new ArmorMaterial(
                ...
                List.of(new ArmorMaterial.Layer(Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, name))),
                0,0
        );
        return Registry.registerReference(Registries.ARMOR_MATERIAL, Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, name), material);
    }
    public static RegistryKey<ItemGroup> KEY = RegistryKey.of(Registries.ITEM_GROUP.getKey(),Identifier.of(RPGMinibosses.CONTENT_NAMESPACE,"armor"));
    ...
    private static Weapon.Entry entry(String requiredMod, String name, Weapon.CustomMaterial material, Weapon.Factory item, WeaponConfig defaults) {
        var entry = new Weapon.Entry(RPGMinibosses.CONTENT_NAMESPACE, name, material, item, defaults, Equipment.WeaponType.DAMAGE_STAFF);
    ...
    public static final Armor.Set despotArmor = Armors.createUniqueSet(
                    despot,
                    Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, "despot"),
                    30,
                    UniqueArmor::new,
                    ArmorSetConfig.with(
                            null    ,
    ...
    public static final Armor.Set foxArmor = Armors.createUniqueSet(
                    foxshade,
                    Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, "foxshade"),
                    30,
                    UniqueArmor::new,
                    ArmorSetConfig.with(
                            null    ,
    ...
    public static final Armor.Set kintsugiArmor = Armors.createUniqueSet(
                    kintsugi,
                    Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, "kintsugi"),
                    30,
                    UniqueArmor::new,
                    ArmorSetConfig.with(
                            null    ,
    ...
    public static final Armor.Set sanguine_red = Armors.createUniqueSet(
                    sanguine_fire,
                    Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, "sanguine_fire"),
                    30,
                    UniqueArmor::new,
                    ArmorSetConfig.with(
                            null    ,
    ...
    public static final Armor.Set sanguine_blue = Armors.createUniqueSet(
                    sanguine_frost,
                    Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, "sanguine_frost"),
                    30,
                    UniqueArmor::new,
                    ArmorSetConfig.with(
                            null    ,
    ...
    public static final Armor.Set sanguine_purple = Armors.createUniqueSet(
                    sanguine_arcane,
                    Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, "sanguine_arcane"),
                    30,
                    UniqueArmor::new,
                    ArmorSetConfig.with(
                            null    ,
    ...
    public static void register(Map<String, WeaponConfig> configs){
        ...
        ABBERRATH = new AbberrathArmor(abberrath, ArmorItem.Type.BOOTS,new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(30)).attributeModifiers(new AttributeModifiersComponent(List.of(
                ...
                new EntityAttributeModifier(Identifier.of(RPGMinibosses.CONTENT_NAMESPACE,"abberraths_hooves"),2, EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.FEET),
                new AttributeModifiersComponent.Entry(EntityAttributes.GENERIC_ARMOR,
                        new EntityAttributeModifier(Identifier.of(RPGMinibosses.CONTENT_NAMESPACE,"armor_boots"),2, EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.FEET)),true)),SpellSchools.FIRE);
        Weapon.register(configs, entries, RPGMinibossesEntities.KEY);
        Registry.register(Registries.ITEM,Identifier.of(RPGMinibosses.CONTENT_NAMESPACE,"abberraths_hooves"),ABBERRATH);
