...
public class ArchmageFireModel<T extends MinibossEntity> extends GeoModel<T> implements ModelWithArms {
    private static final Identifier DEFAULT_LOCATION = Identifier.of(RPGMinibosses.MOD_ID,"textures/mob/archmagetexturefire.png");

    @Override
    public Identifier getModelResource(T reaver) {

        return Identifier.of(RPGMinibosses.MOD_ID,"geo/archmagefire.json");
    }
    @Override
