        ...
        ((WorldScheduler) entity.getWorld()).schedule(20, () -> {
            ...
            ((WorldScheduler) entity.getWorld()).schedule(20, () -> {
                ParticleHelper.sendBatches(entity,
                    SpellRegistry.from(entity.getWorld()).get(Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, "pound")).release.particles);
                for (Entity target : TargetHelper.targetsFromArea(entity, 6, new Spell.Target.Area(), null)) {
                    SpellHelper.performImpacts(entity.getWorld(), entity, target, entity,
                        SpellRegistry.from(entity.getWorld()).getEntry(Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, "pound")).get(),
                        SpellRegistry.from(entity.getWorld()).get(Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, "pound")).impacts,
