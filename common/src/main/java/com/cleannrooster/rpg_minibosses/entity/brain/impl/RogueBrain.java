    ...
    private void performKnifeThrow() {
        ...
        ((WorldScheduler) entity.getWorld()).schedule(20, () -> {
            ...
            SpellHelper.shootProjectile(entity.getWorld(), entity, entity.getTarget(),
                SpellRegistry.from(entity.getWorld()).getEntry(Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, "knifethrow")).get(),
            ...
            ParticleHelper.sendBatches(entity,
                SpellRegistry.from(entity.getWorld()).get(Identifier.of(RPGMinibosses.CONTENT_NAMESPACE, "knifethrow")).release.particles);
