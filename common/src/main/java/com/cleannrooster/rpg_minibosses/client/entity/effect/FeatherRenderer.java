...
public class FeatherRenderer extends OrbitingEffectRenderer {
    ...
    public FeatherRenderer() {
        super(List.of(new OrbitingEffectRenderer.Model(GLOWING_RENDER_LAYER, 				Identifier.of(CONTENT_NAMESPACE, "projectile/feather")
        )), 1F, 1F);
        this.models =List.of( new OrbitingEffectRenderer.Model(GLOWING_RENDER_LAYER, 				Identifier.of(CONTENT_NAMESPACE, "projectile/feather")));
        this.scale = 1F;
