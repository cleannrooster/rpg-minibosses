...
public class GeminiRenderer extends AzEntityRenderer<GeminiEntity> {
    ...
    public static final Identifier FIRE_TEXTURE = Identifier.of(RPGMinibosses.MOD_ID, "textures/mob/gemini.png");
    public static final Identifier FROST_TEXTURE = Identifier.of(RPGMinibosses.MOD_ID, "textures/mob/gemini_blue.png");
    public static final Identifier GEO = Identifier.of(RPGMinibosses.MOD_ID, "geo/gemini.geo.json");
